...
HD_PWD='/home/diego/Desktop/SemArq/211573851_P7/register_file/register_file.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegFile_TestBench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegFile_TestBench.tcl
